...
class StockMarket extends utils.Adapter {
    constructor(options = {}) {
        ...
        this.base_url = 'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=';
    ...
    readStockMarket(apikey) {
        ...
        this.config.stock.split(',').forEach(async (stockKey) => {
            if (this.api_error) {
                ...
                await (0, axios_1.default)(this.base_url + stockKey + '&interval=5min&apikey=' + apikey).then(async (stock_data) => {
